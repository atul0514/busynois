      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <?php echo form_open_multipart('admin/jobcategory/update');?>  
                <div class="form-group row">
                  <div class="col-md-8">
                      <input type="text" name="cat" class="form-control" value="<?php echo $rows->cname; ?>">
                      <input type="hidden" name="id" class="form-control" value="<?php echo $rows->cid; ?>">
                  </div>
                  <div class="col-md-4">
                      <input type="submit" name="submit" value="Update" class="btn btn-danger btn-block">
                  </div>
                </div>
              </form>
            </div>
