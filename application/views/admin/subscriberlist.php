                   ...
                   ?>
                    <tr>
                      ...
                      <td class='text-center'>
                        ...
                        <a class="btn btn-sm btn-danger text-white" data-toggle="modal" data-target="#myModal1-<?php echo $row->id; ?>"><i class=
                    ...
                    <div id="myModal1-<?php echo $row->id; ?>" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <a  href='<?php echo base_url(); ?>admin/dashboard/deletesubscriber?id=<?php echo $row->id; ?>' class="btn btn-danger"  >Yes</a>
