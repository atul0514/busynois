      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <?php echo form_open_multipart('admin/city/update');?>  
                <div class="form-group row">
                  <div class="col-md-4">
                      ...
                      <select name="loc" class="form-control">
                        ...
                        <?php
                            ...
                            {
                            ?>
                            <option value="<?php echo $row->id; ?>" <?php if($rows->lcid == $row->id){ echo 'selected';} ?> ><?php echo $row->loc; ?></option>
                             <?php
                                $i++;
                               }
                         ?>
                  ...
                  <div class="col-md-4">
                      <input type="text" name="city" class="form-control" value="<?php echo $rows->ctame; ?>" placeholder="Enter City">
                  </div>
                  <div class="col-md-4">
